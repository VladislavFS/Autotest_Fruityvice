...
class TestGetFrutsNutrition:
    ...
    def test_get_fruits_nutrition(self, nutrition, ave, max_n):
        ...
        response = Api_test(f'/api/fruit/{nutrition}').fruts_get(valid_schema, params = {'min':min_n, 'max':max_n})
    ...
    def test_get_fruits_nutrition_error(self, nutrition, min_n, max_n):
        response = Api_test(f'/api/fruit/{nutrition}').fruts_get(valid_schema_404, params = {'min':min_n, 'max':max_n})
